...
4. Poll `matlab_job` at bounded intervals; this alpha has no wait action. For cancellation/unknown outcomes, reconcile the existing job and retain its ID. Never rerun to repair response formatting or a lost connection.
